...
<head>
    ...
    <!-- Plugins css -->
    <link rel="stylesheet" href="AdminAssets/plugins/charts-c3/c3.min.css" />

    <!-- Core css -->
    <link rel="stylesheet" href="AdminAssets/css/main.css" />
    <link rel="stylesheet" href="AdminAssets/css/theme1.css" />
</head>
                        ...
                        <div class="right">
                            ...
                            <div class="notification d-flex">
                                ...
                                <div class="dropdown d-flex">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <a class="dropdown-item" href="<?= yii::$app->urlManager->createAbsoluteUrl(['site/profile'])?>"><i class="dropdown-icon fe fe-user"></i> Profile</a>
