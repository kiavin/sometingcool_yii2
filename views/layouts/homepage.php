                ...
                <div class="ed-mm-right">
                    <div class="ed-mm-menu">
                        ...
                        <div class="ed-mm-inn">
                            ...
                            <h4>User Account</h4>
                            <ul>
                                <li><a href="<?= yii::$app->urlManager->createAbsoluteUrl(['site/login']) ?>" data-toggle="modal" data-target="#modal1">Sign In</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="ed-com-t1-right">
                            <ul>
                                <li><a href="<?= yii::$app->urlManager->createAbsoluteUrl(['site/login']) ?>">Sign In</a>
                                </li>
                                <li><a href="<?php echo \yii\helpers\Url::to(['/site/signup']) ?>">Sign Up</a></li>
                            </ul>
                        </div>
